...
root.update()
map_func = MapFn([Point(0, 0), Point(1, 1), Point(0.5, 0.25)])
controller = Canvas(canvas, map_func)
horizontal_ruler = Ruler(ruler_h)
vertical_ruler = Ruler(ruler_v)
horizontal_ruler.render()
vertical_ruler.render()
controller.attach(vertical_ruler)
